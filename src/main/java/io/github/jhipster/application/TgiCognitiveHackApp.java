...
public class TgiCognitiveHackApp {

    private static final Logger log = LoggerFactory.getLogger(TgiCognitiveHackApp.class);

    private final Environment env;

    public TgiCognitiveHackApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes tgiCognitiveHack.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TgiCognitiveHackApp.class);
