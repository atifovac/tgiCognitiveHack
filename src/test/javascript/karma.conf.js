...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/wavesurfer.js/dist/wavesurfer.min.js',
            ...
            'src/main/webapp/bower_components/angularAudioRecorder/dist/angular-audio-recorder.min.js',
